    ...
    def run_operation(self, filename, freq_hz=1):
        ...
        while not rospy.is_shutdown():
            ...
            if self.status == areaStatus.IDLE.value:
                ...
                self.decay(self.tlapse) #TODO: Measure the tlapse here based on rospy.get_time(). Actually, this is correct
                self.tlapse += 1
            ...
            if self.status != areaStatus.IDLE.value:
                ...
                self.sim_t += 1 #This is correct since this includes F being restored
            self.publish_fmeasure()
...
#                 f_record.append(self.fmeasure)
#                 decay_rates_record.append(self.decay_rate)
#                 self.sim_t += 1 #TODO: Make sure the tlapse of area is synonymous with sim_t
#             self.publish_fmeasure()
#
#             if self.save:
#                 pu.dump_data(decay_rates_record, '{}_area{}_decay_rates'.format(filename, self.area))
