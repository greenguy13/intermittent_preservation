...
"""
Heuristic decision making under uncertainty, ver 1.
In this version we learn the decay rates by moving average. We also assume that in future time steps, the forecasted decay stays the same
    as we forecast opportunity cost of decisions.
"""
        ...
        if self.robot_id < 999:
            ...
            while not rospy.is_shutdown() and t<self.t_operation:
                ...
                #TODO: Ensure the cycle of states is correct. Note: oracle should have no replanning state
                    ...
                    measured_decay_param = self.recorded_decay_param[self.mission_area][-1] #TODO: Make sure this is updated timely for each recorded F
                ...
                t += 1
                self.state.append((t, self.curr_loc, self.battery, self.tlapses, self.decay_rates_dict)) #TODO: We can insert the state here
