...
class TaskScheduler:
    def __init__(self, node_name):
        ...
        # Parameters
        self.robot_id = rospy.get_param("~robot_id") #TODO: Potentially, we just get the nrobots
        ...
        charging_station_coords = rospy.get_param("~initial_pose_x"), rospy.get_param("~initial_pose_y")  # rospy.get_param("/charging_station_coords") #TODO: Where to get this?
        ...
        #TODO: Establish the appropriate
